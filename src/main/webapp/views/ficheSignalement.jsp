...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Affectation d'un signalement � une r�gion</h1>
    </div><!-- End Page Title -->
    ...
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Cat�gorie: ${signalement.nomCat}</p>
                <p class="card-text">Sous-cat�gorie: ${signalement.nomSousCat}</p>
